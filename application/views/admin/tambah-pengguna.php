                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <label for="nama_instansi">NIK</label>
                            <input type="text" name="nama_instansi" id="nama_instansi" class="form-control <?= form_error('nama_instansi') ? 'is-invalid' : 'border-left-primary' ?>" value="<?= set_value('nama_instansi'); ?>" placeholder="Masukkan NIK">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" cols="30" rows="1" class="form-control <?= form_error('alamat') ? 'is-invalid' : 'border-left-primary' ?>" placeholder="Masukkan Alamat"><?= set_value('alamat') ?></textarea>
                            <div class="invalid-feedback">
                                <?= form_error('alamat') ?>
                            </div>
                        </div>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; M. Habibullah Yuditama - <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
