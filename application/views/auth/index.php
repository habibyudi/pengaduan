                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-block d-lg-block">
                                        <img src="<?= base_url(); ?>/assets/img/PTMCI.svg" class="m-1" style="width: 120%; height: 98%;">
                                    </div>

                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 my-2">Layanan Pengaduan Online PT MCI</h1>
                                            </div>
                                            <!-- Show Flash_msg -->
                                            ...
                                            <form class="user" method="post" action="<?= base_url() ?>">
                                                ...
                                                <br>
                                                <center>
                                                    <p>Repost by <a href='https://Makuku.co.id/' title='makuku.co.id' target='_blank'>Makuku Indonesia</a></p>
                                                </center>
