...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        ...
        <a href="index.html"><img src="<?= base_url() ?>/aset/img/lapormci.png" alt="" class="img-fluid"></a>
      </div>
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>LAYANAN PENGADUAN <br>ONLINE PT MAKUKU CARE INDONESIA</h2>
        <div>
          <a href="Auth" class="btn-services scrollto">Tulis Pengaduan Anda</a>
          <br>
          <center>
            <p>Repost by <a href='https://makuku.co.id/' title='Makuku.co.id' target='_blank'>Makuku.co.id</a></p>
          </center>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row about-container" id="div">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p>
              <br>Layanan Pengaduan Online PT MAKUKU CARE INDONESIA (LAPOR MCI) Desa berbasis web ini merupakan form keluh kesah masyarakat PT MCI dengan cara mengakses website secara online.
            </p>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bi bi-brightness-high"></i></div>
              <h4 class="title"><a href="">Meningkatkan Mutu Pelayanan</a></h4>
              <p class="description">Dengan adanya Website ini diharapkan dapat meningkatkan pelayanan terhadap kelancaran dalam bekerja</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              <div class="icon"><i class="bi bi-calendar4-week"></i></div>
              <h4 class="title"><a href="">Praktis dan Hemat Waktu</a></h4>
              <p class="description">Dengan adanya Website ini Pegawai MCI dapat melakukan tindakan oleh Staff IT PT MCI</p>
            </div>
    ...
    <section id="services" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Prosedur Pengaduan di Website LAPOR MCI</h3>
        </header>
        ...
        <div class="row" id="div">
          ...
          <div class="col-lg-6">
            <div class="map mb-4 mb-lg-0">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31685.610668693953!2d110.55358695000001!3d-6.926259450000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70ed063eba3cfd%3A0x69bcb61124328ff0!2sPT.%20Makuku%20Care%20Indonesia!5e0!3m2!1sid!2sid!4v1756777278973!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 340px;" allowfullscreen></iframe>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-md-5 info">
                ...
                <p>Jatengland Industrial Park Sayung Blok F No.1 Batu, Kabupaten Demak</p>
              </div>
              <div class="col-md-4 info">
                <i class="bi bi-envelope"></i>
                <p>yudhitama333@gmail.com</p>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6 footer-info footer-links">
            <h3>LAPOR MCI</h3>
            <p>Layanan Pengaduan Online PT Makuku Care Indonesia (LAPOR MCI) berbasis web ini merupakan form keluh kesah karyawan PT MCI dengan cara mengakses website secara online.</p>
            <br>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Kontak Kami</h4>
            <p>
              Jatengland Industrial Park Sayung Blok F No.1<br>
              Kecamatan Batu,<br>
              Kabupaten Demak<br>
              <strong>Phone:</strong> +62 859-000-94242<br>
              <strong>Email:</strong> yudhitama333@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>LAPOR MCI</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
      ...
      -->
        Designed by <a href="https://bootstrapmade.com/">M. Habibullah Yuditama</a> | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
